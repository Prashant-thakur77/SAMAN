...
| Vendors are not de-duplicated | Vendor names come through as the catalogue wrote them; overlap analysis matches on the exact string | The same normaliser that cleans descriptions would clean "SKF INDIA LTD" against "SKF India Limited"; a vendor-alias table is the missing piece |
