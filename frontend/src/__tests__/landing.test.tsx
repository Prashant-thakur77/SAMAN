...
describe('the landing page', () => {
  ...
  it('offers the assistant to a visitor too', () => {
    // The API answers a visitor with the documents and, for anything inside
    // the application, with sign-in first; the widget is the same one.
    renderLanding()
